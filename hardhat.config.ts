...
export default {
  networks: {
    ...
    arbgoerli: {
      url: 'https://goerli-rollup.arbitrum.io/rpc', //`https://rinkeby.arbitrum.io/rpc`,
      accounts: [pk],
      chainId: 421613,
    },
  },
  ...
  etherscan: {
    apiKey: {
      ...
      arbitrumOne: process.env.ETHERSCAN_KEY,
    },
  },
  mocha: {
    timeout: 4000000,
  ...
  storageLayoutChanges: {
    contracts: ['VodkaVault', 'WaterVault', 'DnGmxBatchingManager'],
    fullPath: false,
  },
  namedAccounts: {
