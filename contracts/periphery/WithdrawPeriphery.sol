...
contract WithdrawPeriphery is Ownable {
    ...
    function setAddresses(IVodkaVault _VodkaVault, IRewardRouterV2 _rewardRouter) external onlyOwner {
    ...
    function withdrawToken(
        ...
        uint256 shares = VodkaVault.withdraw(sGlpAmount, address(this), msg.sender);
    ...
    function redeemToken(
        ...
        // user has approved periphery to use junior vault shares
        uint256 assets = VodkaVault.redeem(sharesAmount, address(this), msg.sender);
