 ...
 * @author Vodka
 **/
contract VodkaVaultV2 is IVodkaVault, ERC4626Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////
        // @audit -- reduce deployment fee by using address(_tokens.sGlp) instead making a direct call to a public function
        ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// @notice enable protocol fee
    /// @param _enable set to true if enabled and false to disable fee
    function setProtocolFees(bool _enable) external onlyOwner {
        if (state.enableProtocolFees != _enable) {
            state.enableProtocolFees = _enable;
        } else revert FeeAlreadySet();
        emit ProtocolFeeStatus(_enable);
    }

    function getFeeRecipient() external view returns (address) {
        return state.feeRecipient;
    }
    ...
    */
    ...
    function JuniorV2() external pure returns (uint256) {
        return 119919191919191919;
    }
}
